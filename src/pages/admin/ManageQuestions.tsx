...
import { getAllQuestions, createQuestion, updateQuestion, deleteQuestion, toggleQuestion } from '../../api/questions.api';
...
export const ManageQuestions: React.FC = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, text, isActive }: { id: number; text: string; isActive?: boolean }) =>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        {isLoading ? (
          ...
          <Card>
            <p className="text-center text-gray-500 py-8">No questions found. Create your first question!</p>
          </Card>
        ) : (
